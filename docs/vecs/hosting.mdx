...
`vecs` is compatible with any Postgres 13+ with the [pgvector](https://github.com/pgvector/pgvector) extension installed.
...
![sign up](/images/vecs/supabase_sign_up.png)

#### Create a new project

Select `New Project`

![new_project_promp](/images/vecs/supabase_new_project_prompt.png)

Complete the prompts. Be sure to remember or write down your password as we'll need that when connecting with vecs.

![new_project](/images/vecs/supabase_new_project.png)

#### Connection Info

On the project page, navigate to `Settings` > `Database` > `Database Settings`

![connection_info](/images/vecs/supabase_connection_info.png)
...
Keep that connection string secret and safe. Its your `DB_CONNECTION` in the [quickstart guide](/api),
...
Keep that connection string secret and safe. Its your `DB_CONNECTION` in the [quickstart guide](/vecs/api)
