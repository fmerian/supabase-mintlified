...
Records can be [added to or updated in](/api#upserting-vectors) a collection.
Collections can be [queried](/api#query) at any time, but should be [indexed](/api#create-an-index) for scalable query performance.
