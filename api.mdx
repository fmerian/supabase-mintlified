...
For a complete reference, see the [metadata guide](/concepts/metadata).
...
For a complete list of available adapters, see [built-in adapters](/concepts/adapters#built-in-adapters).
